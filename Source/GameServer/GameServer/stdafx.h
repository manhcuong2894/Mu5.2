...
#define CB_BXHDMG					1
#define CB_CUSTOMGIFTCODE			1
#define CB_QUAPHUCLOI				1
#define CUSTOM_GHRS					1
#define CUSTOM_CHANGEITEM			1
#define CUSTOM_VONGQUAY				1
#define CUSTOM_MOCNAP				1
#define CUSTOM_CHOTROI				1
#define FAKE_ONLINE					1
...
#pragma comment(lib, "Lib\\APIGameGuard.lib")
