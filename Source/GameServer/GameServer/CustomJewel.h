...
struct CUSTOM_JEWEL_UPDATE_INFO
{
	int Index;
	int ItemOld;
	int ItemNew;
...
struct CUSTOM_JEWEL_INFO
{
	...
	std::map<int, CUSTOM_JEWEL_UPDATE_INFO> UpdateInfo;
};
...
public:
	...
	void SetUpdateInfo(CUSTOM_JEWEL_UPDATE_INFO info);
	...
	int GetUpdateInfo(int ItemIndex, int ItemOld);
