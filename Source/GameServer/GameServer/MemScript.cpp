...
__int64 CMemScript::GetInt64Number() // OK
{
	if (strcmp(this->m_string, "*") == 0)
	{
		return -1;
	...
	return _strtoi64(this->m_string, 0, 10);
}

__int64 CMemScript::GetAsInt64Number() // OK
{
	this->GetToken();

	return this->GetInt64Number();
}

float CMemScript::GetFloatNumber() // OK
{
	return (float)this->m_number;
}
...
double CMemScript::GetDoubleNumber() // OK
{
	return this->m_number;
}

double CMemScript::GetAsDoubleNumber() // OK
{
	this->GetToken();
