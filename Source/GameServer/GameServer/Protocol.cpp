...
static DWORD GetProtocolDwordValueFromDouble(double value) {
  if (value <= 0.0) {
    return 0;
  }

  if (value >= (double)MAXDWORD) {
    return MAXDWORD;
  }
...
static DWORD GetProtocolDwordValueFromQword(QWORD value) {
  return (value > (QWORD)MAXDWORD) ? MAXDWORD : (DWORD)value;
}

void ProtocolCore(BYTE head, BYTE *lpMsg, int size, int aIndex, int encrypt,
                  int serial) // OK
{
  PROTECT_START;
  ...
  if (gObj[aIndex].Type == OBJECT_USER &&
      gHackPacketCheck.CheckPacketHack(
          aIndex, head, ((lpMsg[0] == 0xC1) ? lpMsg[3] : lpMsg[4]), encrypt,
          serial) == 0) {
    return;
  }
#if (ANTIHACK_GGNEW)
  if (gObj[aIndex].Type == OBJECT_USER)
  {
      gAPIGameGuard.PacketRecv(head, lpMsg, size, aIndex, encrypt, serial);
  }
#endif
  ...
  case 0x1C:
    ...
    break;
  case 0x1E:
    gSkillManager.CGDurationSkillAttackRecv(
        (PMSG_DURATION_SKILL_ATTACK_RECV *)lpMsg, aIndex);
    break;
  case 0x20:
  ...
  case 0x3F:
    switch (lpMsg[3]) {
    case 0x01:
      gPersonalShop.CGPShopSetItemPriceRecv(
          (PMSG_PSHOP_SET_ITEM_PRICE_RECV *)lpMsg, aIndex);
      break;
    case 0x02:
    ...
    case 0x03:
      ...
      break;
    case 0x05:
      gPersonalShop.CGPShopItemListRecv((PMSG_PSHOP_ITEM_LIST_RECV *)lpMsg,
                                        aIndex);
      break;
    case 0x06:
      gPersonalShop.CGPShopBuyItemRecv((PMSG_PSHOP_BUY_ITEM_RECV *)lpMsg,
                                       aIndex);
      break;
    case 0x07:
  ...
  case 0x40:
    ...
    break;
  case 0x41:
    gParty.CGPartyRequestResultRecv((PMSG_PARTY_REQUEST_RESULT_RECV *)lpMsg,
                                    aIndex);
    break;
  case 0x42:
  ...
  case 0x4A:
    ...
    gSkillManager.CGRageFighterSkillAttackRecv(
        (PMSG_RAGE_FIGHTER_SKILL_ATTACK_RECV *)lpMsg, aIndex);
#endif
    break;
  case 0x4B:
#if (GAMESERVER_UPDATE >= 601)
    gSkillManager.CGSkillDarkSideRecv((PMSG_SKILL_DARK_SIDE_RECV *)lpMsg,
                                      aIndex);
#endif
    break;
  case 0x4C:
    ...
    case 0x01:
#if (GAMESERVER_UPDATE >= 601)
      gMiningSystem.CGMiningSuccessRecv((PMSG_MINING_SUCCESS_RECV *)lpMsg,
                                        aIndex);
#endif
      break;
    case 0x03:
#if (GAMESERVER_UPDATE >= 601)
      gMiningSystem.CGMiningFailureRecv((PMSG_MINING_FAILURE_RECV *)lpMsg,
                                        aIndex);
#endif
      break;
    }
  ...
  case 0x4D:
    ...
    case 0x00:
      ...
      gEventInventory.CGEventItemGetRecv((PMSG_EVENT_ITEM_GET_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x01:
#if (GAMESERVER_UPDATE >= 802)
      gEventInventory.CGEventItemDropRecv((PMSG_EVENT_ITEM_DROP_RECV *)lpMsg,
                                          aIndex);
#endif
      break;
    case 0x0F:
#if (GAMESERVER_UPDATE >= 802)
      gEventInventory.CGEventInventoryOpenRecv(
          (PMSG_EVENT_INVENTORY_OPEN_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x10:
#if (GAMESERVER_UPDATE >= 802)
  ...
  case 0x82:
    ...
    break;
  case 0x83:
    gWarehouse.CGWarehousePasswordRecv((PMSG_WAREHOUSE_PASSWORD_RECV *)lpMsg,
                                       aIndex);
    break;
  case 0x86:
  ...
  case 0x8E:
    ...
    break;
  case 0x90:
    gDevilSquare.CGDevilSquareEnterRecv((PMSG_DEVIL_SQUARE_ENTER_RECV *)lpMsg,
                                        aIndex);
    break;
  case 0x91:
    ...
    break;
  case 0x9A:
    gBloodCastle.CGBloodCastleEnterRecv((PMSG_BLOOD_CASTLE_ENTER_RECV *)lpMsg,
                                        aIndex);
    break;
  case 0xA0:
  ...
  case 0xAF:
    switch (lpMsg[3]) {
    case 0x01:
      gChaosCastle.CGChaosCastleEnterRecv((PMSG_CHAOS_CASTLE_ENTER_RECV *)lpMsg,
                                          aIndex);
      break;
    case 0x02:
      gChaosCastle.CGChaosCastlePositionRecv(
          (PMSG_CHAOS_CASTLE_POSITION_RECV *)lpMsg, aIndex);
      break;
    }
    break;
  case 0xB0:
    gSkillManager.CGSkillTeleportAllyRecv(
        (PMSG_SKILL_TELEPORT_ALLY_RECV *)lpMsg, aIndex);
    break;
  case 0xB1:
    switch (lpMsg[3]) {
    case 0x01:
  ...
  case 0xB7:
    switch (lpMsg[3]) {
    case 0x01:
      gCastleSiegeWeapon.CGCastleSiegeWeaponUseRecv(
          (PMSG_CASTLE_SIEGE_WEAPON_USE_RECV *)lpMsg, aIndex);
      break;
    case 0x04:
      gCastleSiegeWeapon.CGCastleSiegeWeaponDamageRecv(
          (PMSG_CASTLE_SIEGE_WEAPON_DAMAGE_RECV *)lpMsg, aIndex);
      break;
    }
    break;
  case 0xB9:
    switch (lpMsg[3]) {
    case 0x02:
      CGReqGuildMarkOfCastleOwner((PMSG_REQ_GUILDMARK_OF_CASTLEOWNER *)lpMsg,
                                  aIndex);
      break;
    case 0x05:
      CGReqCastleHuntZoneEntrance((PMSG_REQ_MOVE_TO_CASTLE_HUNTZONE *)lpMsg,
                                  aIndex);
      break;
    }
    break;
  ...
  case 0xBD:
    ...
    case 0x00:
      ...
      break;
    case 0x03:
      gCrywolf.CGCrywolfAltarContractRecv(
          (PMSG_CRYWOLF_ALTAR_CONTRACT_RECV *)lpMsg, aIndex);
      break;
    case 0x09:
  ...
  case 0xBF:
    switch (lpMsg[3]) {
    case 0x00:
      gIllusionTemple.CGIllusionTempleEnterRecv(
          (PMSG_ILLUSION_TEMPLE_ENTER_RECV *)lpMsg, aIndex);
      break;
    case 0x02:
      gIllusionTemple.CGIllusionTempleSkillRecv(
          (PMSG_ILLUSION_TEMPLE_SKILL_RECV *)lpMsg, aIndex);
      break;
    case 0x05:
    ...
    case 0x0B:
#if (GAMESERVER_UPDATE >= 402)
      gLuckyCoin.CGLuckyCoinCountRecv((PMSG_LUCKY_COIN_COUNT_RECV *)lpMsg,
                                      aIndex);
#endif
      break;
    case 0x0C:
#if (GAMESERVER_UPDATE >= 402)
      gLuckyCoin.CGLuckyCoinRegisterRecv((PMSG_LUCKY_COIN_REGISTER_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0D:
#if (GAMESERVER_UPDATE >= 402)
      gLuckyCoin.CGLuckyCoinExchangeRecv((PMSG_LUCKY_COIN_EXCHANGE_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0E:
#if (GAMESERVER_UPDATE >= 501)
      gDoubleGoer.CGDoubleGoerEnterRecv((PMSG_DOUBLE_GOER_ENTER_RECV *)lpMsg,
                                        aIndex);
#endif
      break;
    case 0x17:
    ...
    case 0x20:
#if (GAMESERVER_UPDATE >= 501)
      gInventoryEquipment.CGInventoryEquipmentRecv(
          (PMSG_INVENTORY_EQUIPMENT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x51:
#if (GAMESERVER_UPDATE >= 603)
      ...
      //	break;
    case 0x4F:
      gCB_GiftCode.RecvProtocol(lpMsg, aIndex);
      break;
    case 0x70:
#if (GAMESERVER_UPDATE >= 803) // esse
      gIllusionTemple.CGIllusionTempleEnterRecv(
          (PMSG_ILLUSION_TEMPLE_ENTER_RECV *)lpMsg, aIndex); // Original
#endif
      break;
    default:
  ...
  case 0xD0:
    ...
    case 0x05:
#if (GAMESERVER_UPDATE <= 402)
      gPcPoint.CGPcPointItemBuyRecv((PMSG_PC_POINT_ITEM_BUY_RECV *)lpMsg,
                                    aIndex);
#endif
      break;
    case 0x06:
  ...
  case 0xD2:
    ...
    case 0x03:
#if (GAMESERVER_UPDATE >= 501)
      gCashShop.CGCashShopItemBuyRecv((PMSG_CASH_SHOP_ITEM_BUY_RECV *)lpMsg,
                                      aIndex);
#endif
      break;
    case 0x04:
#if (GAMESERVER_UPDATE >= 501)
      gCashShop.CGCashShopItemGifRecv((PMSG_CASH_SHOP_ITEM_GIF_RECV *)lpMsg,
                                      aIndex);
#endif
      break;
    case 0x05:
#if (GAMESERVER_UPDATE >= 501)
      gCashShop.CGCashShopItemNumRecv((PMSG_CASH_SHOP_ITEM_NUM_RECV *)lpMsg,
                                      aIndex);
#endif
      break;
    case 0x0B:
#if (GAMESERVER_UPDATE >= 501)
      gCashShop.CGCashShopItemUseRecv((PMSG_CASH_SHOP_ITEM_USE_RECV *)lpMsg,
                                      aIndex);
#endif
      break;
    }
  ...
  case PROTOCOL_CODE1:
    ...
    break;
  case PROTOCOL_CODE4:
    gSkillManager.CGMultiSkillAttackRecv((PMSG_MULTI_SKILL_ATTACK_RECV *)lpMsg,
                                         aIndex, 0);
    break;
  case 0xE1:
    gGuild.CGGuildAssignStatusRecv((PMSG_GUILD_ASSIGN_STATUS_RECV *)lpMsg,
                                   aIndex);
    break;
  case 0xE2:
    ...
    break;
  case 0xE5:
    CGRelationShipReqJoinBreakOff((PMSG_RELATIONSHIP_JOIN_BREAKOFF_REQ *)lpMsg,
                                  aIndex);
    break;
  case 0xE6:
    CGRelationShipAnsJoinBreakOff((PMSG_RELATIONSHIP_JOIN_BREAKOFF_ANS *)lpMsg,
                                  aIndex);
    break;
  case 0xE7:
    switch (lpMsg[3]) {
  ...
  case 0xEB:
    switch (lpMsg[3]) {
    case 0x01:
      CGRelationShipReqKickOutUnionMember((PMSG_KICKOUT_UNIONMEMBER_REQ *)lpMsg,
                                          aIndex);
      break;
    }
    break;
  case 0xEC:
    ...
    case 0x00:
      ...
      gPentagramSystem.CGPentagramJewelInsertRecv(
          (PMSG_PENTAGRAM_JEWEL_INSERT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x01:
#if (GAMESERVER_UPDATE >= 701)
      gPentagramSystem.CGPentagramJewelRemoveRecv(
          (PMSG_PENTAGRAM_JEWEL_REMOVE_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x02:
#if (GAMESERVER_UPDATE >= 701)
      gPentagramSystem.CGPentagramJewelRefineRecv(
          (PMSG_PENTAGRAM_JEWEL_REFINE_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x03:
#if (GAMESERVER_UPDATE >= 701)
      gPentagramSystem.CGPentagramJewelUpgradeRecv(
          (PMSG_PENTAGRAM_JEWEL_UPGRADE_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x31:
#if (GAMESERVER_UPDATE >= 802)
    ...
    case 0x33:
#if (GAMESERVER_UPDATE >= 802)
      gPersonalShop.CGPShopSearchLogRecv((PMSG_PSHOP_SEARCH_LOG_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    }
  ...
  case 0xED:
    ...
    case 0x00:
      ...
      gGuildMatching.CGGuildMatchingListRecv(
          (PMSG_GUILD_MATCHING_LIST_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x01:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingListSearchRecv(
          (PMSG_GUILD_MATCHING_LIST_SEARCH_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x02:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingInsertRecv(
          (PMSG_GUILD_MATCHING_INSERT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x03:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingCancelRecv(
          (PMSG_GUILD_MATCHING_CANCEL_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x04:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingJoinInsertRecv(
          (PMSG_GUILD_MATCHING_JOIN_INSERT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x05:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingJoinCancelRecv(
          (PMSG_GUILD_MATCHING_JOIN_CANCEL_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x06:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingJoinAcceptRecv(
          (PMSG_GUILD_MATCHING_JOIN_ACCEPT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x07:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingJoinListRecv(
          (PMSG_GUILD_MATCHING_JOIN_LIST_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x08:
#if (GAMESERVER_UPDATE >= 801)
      gGuildMatching.CGGuildMatchingJoinInfoRecv(
          (PMSG_GUILD_MATCHING_JOIN_INFO_RECV *)lpMsg, aIndex);
#endif
      break;
    }
    break;
  case 0xEF:
    ...
    case 0x00:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingInsertRecv(
          (PMSG_PARTY_MATCHING_INSERT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x01:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingListRecv(
          (PMSG_PARTY_MATCHING_LIST_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x02:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingJoinInsertRecv(
          (PMSG_PARTY_MATCHING_JOIN_INSERT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x03:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingJoinInfoRecv(
          (PMSG_PARTY_MATCHING_JOIN_INFO_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x04:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingJoinListRecv(
          (PMSG_PARTY_MATCHING_JOIN_LIST_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x05:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingJoinAcceptRecv(
          (PMSG_PARTY_MATCHING_JOIN_ACCEPT_RECV *)lpMsg, aIndex);
#endif
      break;
    case 0x06:
#if (GAMESERVER_UPDATE >= 801)
      gPartyMatching.CGPartyMatchingJoinCancelRecv(
          (PMSG_PARTY_MATCHING_JOIN_CANCEL_RECV *)lpMsg, aIndex);
#endif
      break;
    }
    break;
  ...
  case 0xD3:
    ...
    case 0x05: {
      ...
      GJSendRegOrLostPass(aIndex, BpMsg->TypeSend, BpMsg->account,
                          BpMsg->password, BpMsg->numcode, BpMsg->sodienthoai);

    } break;
#endif
#if (CB_QUAPHUCLOI)
    case 0x4D:
      gCB_QuaPhucLoi.RecvClient(lpMsg, aIndex);
      break;
    case 0x4E:
      gCB_QuaPhucLoi.RecvClientNhanQua(lpMsg, aIndex);
      break;
#endif
    ...
    case 0x02: // ViewCharInfo
    {
      ...
      XULY_CGPACKET *pRecv = (XULY_CGPACKET *)lpMsg;
      int targetIndex = (int)pRecv->ThaoTac;

      if (OBJECT_RANGE(targetIndex) == 0 ||
          gObjIsConnectedGP(targetIndex) == 0) {
        return;
      }
...
#pragma pack(pop)
      ...
      int itemCount = 19; // MAX_NEW_EQUIPMENT on client
      int totalSize =
          sizeof(VIEWCHAR_HEADER) + sizeof(VIEWCHAR_ITEM) * itemCount;

      BYTE *pBuffer = new BYTE[totalSize];
      memset(pBuffer, 0, totalSize);

      VIEWCHAR_HEADER *pHeader = (VIEWCHAR_HEADER *)pBuffer;
      pHeader->header.set(0xD3, 0x02, (WORD)totalSize);
      pHeader->Count = itemCount;

      memset(pHeader->Name, 0, sizeof(pHeader->Name));
      memcpy(pHeader->Name, lpTarget->Name, min(strlen(lpTarget->Name), 10));

      int defaultPoints =
          gCharacterManager.m_DefaultClassInfo[lpTarget->Class].Strength;
      defaultPoints +=
          gCharacterManager.m_DefaultClassInfo[lpTarget->Class].Dexterity;
      defaultPoints +=
          gCharacterManager.m_DefaultClassInfo[lpTarget->Class].Vitality;
      defaultPoints +=
          gCharacterManager.m_DefaultClassInfo[lpTarget->Class].Energy;
      defaultPoints +=
          gCharacterManager.m_DefaultClassInfo[lpTarget->Class].Leadership;

      int currentPoints = lpTarget->Strength + lpTarget->Dexterity +
                          lpTarget->Vitality + lpTarget->Energy +
                          lpTarget->Leadership;
      int allocatedPoints =
          ((currentPoints > defaultPoints) ? (currentPoints - defaultPoints)
                                           : 0);

      pHeader->Reset = lpTarget->Reset;
      pHeader->Level = lpTarget->Level;
      pHeader->MasterLevel = lpTarget->MasterLevel;
      pHeader->TotalPoints = allocatedPoints + lpTarget->LevelUpPoint;

      memset(pHeader->GuildName, 0, sizeof(pHeader->GuildName));
      if (lpTarget->GuildNumber > 0 && lpTarget->GuildName[0] != 0) {
        memcpy(pHeader->GuildName, lpTarget->GuildName,
               min(strlen(lpTarget->GuildName), 8));
      }

      pHeader->AccountLevel = lpTarget->AccountLevel;
      pHeader->Class = (BYTE)(lpTarget->CharSet[EQUIPMENT_HELPER] & 0x7F);
      memcpy(pHeader->Equipment, lpTarget->CharSet, sizeof(pHeader->Equipment));

      // Map client slot index -> GS Inventory index
      int slotMap[19] = {
          0,   // EQUIPMENT_WEAPON_RIGHT
          1,   // EQUIPMENT_WEAPON_LEFT
          2,   // EQUIPMENT_HELM
          3,   // EQUIPMENT_ARMOR
          4,   // EQUIPMENT_PANTS
          5,   // EQUIPMENT_GLOVES
          ...
          8,   // EQUIPMENT_HELPER
          9,   // EQUIPMENT_AMULET
          10,  // EQUIPMENT_RING_RIGHT
          11,  // EQUIPMENT_RING_LEFT
          -1,  // EQUIPMENT_PENTAGRAM (skip)
          237, // EQUIPMENT_MUUN
          238, // EQUIPMENT_EAGLE
          239, // EQUIPMENT_ERING_R
          240, // EQUIPMENT_ERING_L
          -1,  // EQUIPMENT_WING_CORE (skip)
          -1,  // EQUIPMENT_FLAG_NAT (skip)
      };

      VIEWCHAR_ITEM *pItems =
          (VIEWCHAR_ITEM *)(pBuffer + sizeof(VIEWCHAR_HEADER));
      for (int i = 0; i < itemCount; i++) {
        int gsSlot = slotMap[i];
        if (gsSlot >= 0 && gsSlot < INVENTORY_SIZE &&
            lpTarget->Inventory[gsSlot].IsItem() != 0) {
          gItemManager.ItemByteConvert(pItems[i].Item,
                                       lpTarget->Inventory[gsSlot]);
          pItems[i].Dur = (BYTE)lpTarget->Inventory[gsSlot].m_Durability;
          pItems[i].PeriodTime =
              (int)lpTarget->Inventory[gsSlot].m_PeriodicItemTime;
        } else {
          memset(pItems[i].Item, 0xFF, sizeof(pItems[i].Item));
          pItems[i].Dur = 0;
          pItems[i].PeriodTime = 0;
        }
      }

      DataSend(aIndex, pBuffer, totalSize);
      delete[] pBuffer;
    } break;
    case 0x2E: {
      if (!lpMsg) {
      ...
      gH_BotMix.SendDataIsTrade(lpObj->Index, -1,
                                H_BotMix::eSendRecvListItemMix, Recv->ThaoTac);
    } break;
    ...
    case 0x6A: {
      ...
      gCustomChangeItem.SetStateInterface(lpObj->Index, 0);
    } break;
    case 0x6B: {
      PMSG_CHANGEITEM_ITEM_RECV *Recv = (PMSG_CHANGEITEM_ITEM_RECV *)lpMsg;
      int slot = Recv->Source;

      if (slot < INVENTORY_WEAR_SIZE) {
        slot += INVENTORY_WEAR_SIZE;
      }

      gCustomChangeItem.ProcItemSend(aIndex, slot);
    } break;
    case 0x6C: {
      XULY_CGPACKET *Recv = (XULY_CGPACKET *)lpMsg;
      if (Recv->ThaoTac == -1) {
      ...
      gCustomChangeItem.BackItem(lpObj->Index, Recv->ThaoTac);
    } break;
#endif
    case 0x40:
    ...
    // CustomVongQuay
    case 0x8A: {
      // Client gửi yêu cầu quay
      XULY_CGPACKET_SOLAN *Recv = (XULY_CGPACKET_SOLAN *)lpMsg;
      gCustomVongQuay.ActionVongQuay(aIndex, Recv->ThaoTac, Recv->SoLan);
    } break;
    case 0x8B: {
      // Client yêu cầu danh sách item của VQ cụ thể
      XULY_CGPACKET *Recv = (XULY_CGPACKET *)lpMsg;
      gCustomVongQuay.SendListNhanThuong(aIndex, Recv->ThaoTac);
    } break;
    case 0x8C: {
      // Client mở giao diện, yêu cầu danh sách VQ
      XULY_CGPACKET *Recv = (XULY_CGPACKET *)lpMsg;
      if (Recv->ThaoTac == 1) {
        gCustomVongQuay.UserSendClientInfo(aIndex);
      }
    } break;
    case 0x8D: {
      XULY_CGPACKET_NHANTICHLUY *Recv = (XULY_CGPACKET_NHANTICHLUY *)lpMsg;
      gCustomVongQuay.ClaimTichLuyReward(aIndex, Recv->Index);
    } break;
#if (CUSTOM_MOCNAP)
    case 0x9A: // Nhận thưởng mốc nạp
    {
      XULY_CGPACKET *mlpMsg = (XULY_CGPACKET *)lpMsg;
      if (!mlpMsg->ThaoTac) {
        return;
    ...
    case 0x9B: // Xem danh sách phần thưởng 1 mốc
    {
      XULY_CGPACKET *mlpMsg = (XULY_CGPACKET *)lpMsg;
      if (!mlpMsg->ThaoTac) {
        return;
    ...
    case 0x9D: // Tạo link thanh toán payOS
    {
      PMSG_MOCNAP_PAYMENT_CREATE_RECV *mlpMsg =
          (PMSG_MOCNAP_PAYMENT_CREATE_RECV *)lpMsg;
      gMocNap.CreatePaymentLink(aIndex, mlpMsg->Amount);
    } break;
#endif
#if (CUSTOM_CHOTROI)
    case 0x10: {
    ...
    case 0x12: {
      XULY_CGPACKET *Recv = (XULY_CGPACKET *)lpMsg;
      gBCustomChoTroi.RollBack(aIndex, Recv);
    } break;
    case 0x13: {
      PMSG_REQ_MARKET_ITEM_MOVE *Recv = (PMSG_REQ_MARKET_ITEM_MOVE *)lpMsg;
      gBCustomChoTroi.ClientSendItemRaoBan(aIndex, Recv);
    } break;
    case 0x14: {
      PMSG_REQ_MARKET_SELL *Recv = (PMSG_REQ_MARKET_SELL *)lpMsg;
      gBCustomChoTroi.CGReqItemSell(Recv, aIndex);
    } break;
    case 0x20: {
      PMSG_REQ_MARKET_ITEM *Recv = (PMSG_REQ_MARKET_ITEM *)lpMsg;
      gBCustomChoTroi.CGReqItemList(Recv, aIndex);
    } break;
    case 0x21: {
      PMSG_REQ_MARKET_BUY *Recv = (PMSG_REQ_MARKET_BUY *)lpMsg;
      gBCustomChoTroi.CGReqItemBuy(Recv, aIndex);
    } break;
#endif
    }
    break;
  case 0xF3:
    ...
    case 0x16:
#if (GAMESERVER_UPDATE >= 401)
      CGCharacterNameChangeRecv((PMSG_CHARACTER_NAME_CHANGE_RECV *)lpMsg,
                                aIndex);
#endif
      break;
    case 0x21:
    ...
    case 0x31:
#if (GAMESERVER_UPDATE >= 701)
      CGClientSecurityBreachRecv((PMSG_CLIENT_SECURITY_BREACH_RECV *)lpMsg,
                                 aIndex);
#endif
      break;
    case 0x52:
#if (GAMESERVER_UPDATE >= 401)
      gMasterSkillTree.CGMasterSkillRecv((PMSG_MASTER_SKILL_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0xE6:
      ...
      break;
    case 0xE7:
      gCustomRanking.GCReqRankingCount(aIndex,
                                       (PMSG_CUSTOM_RANKING_COUNT_RECV *)lpMsg);
      break;
    case 0xE8:
      gCustomEventTime.GCReqEventTime(aIndex,
                                      (PMSG_CUSTOM_EVENTTIME_RECV *)lpMsg);
      break;
    case 0xEB:
  ...
  case 0xF6:
    ...
    case 0x0A:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldDialogRecv((PMSG_QUEST_WORLD_DIALOG_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0B:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldAcceptRecv((PMSG_QUEST_WORLD_ACCEPT_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0D:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldFinishRecv((PMSG_QUEST_WORLD_FINISH_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0F:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldCancelRecv((PMSG_QUEST_WORLD_CANCEL_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x10:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldButtonRecv((PMSG_QUEST_WORLD_BUTTON_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x1B:
#if (GAMESERVER_UPDATE >= 501)
      gQuestWorld.CGQuestWorldDetailRecv((PMSG_QUEST_WORLD_DETAIL_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x30:
  ...
  case 0xF7:
    ...
    case 0x01:
#if (GAMESERVER_UPDATE >= 501)
      gImperialGuardian.CGImperialGuardianEnterRecv(
          (PMSG_IMPERIAL_GUARDIAN_ENTER_RECV *)lpMsg, aIndex);
#endif
      break;
    }
    break;
  case 0xF8:
    ...
    case 0x01:
#if (GAMESERVER_UPDATE >= 501)
      gGensSystem.CGGensSystemInsertRecv((PMSG_GENS_SYSTEM_INSERT_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x03:
#if (GAMESERVER_UPDATE >= 501)
      gGensSystem.CGGensSystemDeleteRecv((PMSG_GENS_SYSTEM_DELETE_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x09:
#if (GAMESERVER_UPDATE >= 501)
      gGensSystem.CGGensSystemRewardRecv((PMSG_GENS_SYSTEM_REWARD_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x0B:
#if (GAMESERVER_UPDATE >= 501)
      gGensSystem.CGGensSystemMemberRecv((PMSG_GENS_SYSTEM_MEMBER_RECV *)lpMsg,
                                         aIndex);
#endif
      break;
    case 0x20:
    ...
    case 0x45:
      ...
      break;
    case 0x4B:
      // CAcheronGuardianEvent::CGReqAcheronEventEnter(&g_AcheronGuardianEvent,(_tagPMSG_REQ_ACHERON_EVENT_ENTER
      // *)aRecv,aIndex);
      break;
    }
    break;
...
void CGChatRecv(PMSG_CHAT_RECV *lpMsg, int aIndex) // OK
{
  ...
  gLog.Output(LOG_CHAT, "[General][%s][%s] - (Message: %s)", lpObj->Account,
              lpObj->Name, lpMsg->message);
  ...
  if (lpObj->ChatLimitTime > 0) {
    gNotice.GCNoticeSend(aIndex, 1, 0, 0, 0, 0, 0, gMessage.GlobalText(269),
                         lpObj->ChatLimitTime);
    return;
  }
  ...
  if (gServerInfo.m_SwitchChatAntiSpam == 1) {
    if (GMAntiSpam->InvokeMessage(lpObj->Account, lpMsg->message) == false) {
      ...
      gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0,
                           gMessage.GlobalText(269), lpObj->ChatLimitTime);
      return;
    }
  }
  ...
  if (lpMsg->message[0] == '~') {
    if (OBJECT_RANGE(lpObj->PartyNumber) != 0) {
      for (int n = 0; n < MAX_PARTY_USER; n++) {
        if (OBJECT_RANGE(gParty.m_PartyInfo[lpObj->PartyNumber].Index[n]) !=
            0) {
          DataSend(gParty.m_PartyInfo[lpObj->PartyNumber].Index[n],
                   (BYTE *)&pMsg, pMsg.header.size);
        }
      }
    }
    ...
    if (lpObj->Guild != 0) {
      if (lpMsg->message[1] == '>') {
        ...
        if (lpObj->Guild->GuildUnion != 0) {
          GDUnionServerGroupChattingSend(lpObj->Guild->GuildUnion, lpMsg->name,
                                         lpMsg->message);
        }
      } else {
        if (lpObj->Guild->Number != 0) {
          GDGuildServerGroupChattingSend(lpObj->Guild->Number, lpMsg->name,
                                         lpMsg->message);
        }
      }
    }
...
void CGChatWhisperRecv(PMSG_CHAT_WHISPER_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (gParty.IsLeader(lpTarget->PartyNumber, lpTarget->Index) != 0) {
    if (gParty.PartyPasswordCheck(lpTarget->PartyNumber,
                                  std::string(lpMsg->message)) != 0) {
  ...
  gLog.Output(LOG_CHAT, "[Whisper][%s][%s] - (Name: %s, Message: %s)",
              lpObj->Account, lpObj->Name, name, lpMsg->message);
...
void CGMainCheckRecv(PMSG_MAIN_CHECK_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (gServerInfo.m_MainChecksum != 0) {
    if (lpObj->CheckSumTableNum < 0 ||
        lpObj->CheckSumTableNum >= MAX_CHECKSUM_KEY) {
      gLog.Output(LOG_HACK, "[%s][%s] Main CheckSum error", lpObj->Account,
                  lpObj->Name);
    ...
    if (gCheckSum[lpObj->CheckSumTableNum] != lpMsg->key) {
      gLog.Output(LOG_HACK, "[%s][%s] Invalid Main CheckSum", lpObj->Account,
                  lpObj->Name);
      GCCloseClientSend(aIndex, 0);
      return;
    }
...
void CGLiveClientRecv(PMSG_LIVE_CLIENT_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (gServerInfo.m_CheckLatencyHack != 0 &&
      abs((int)((GetTickCount() - lpObj->ServerTickCount) -
                (lpMsg->TickCount - lpObj->ClientTickCount))) >
          gServerInfo.m_CheckLatencyHackTolerance) {
    gLog.Output(LOG_HACK, "[%s][%s] Client Latency Hack Detected [%d][%d]",
                lpObj->Account, lpObj->Name,
                (GetTickCount() - lpObj->ServerTickCount),
                (lpMsg->TickCount - lpObj->ClientTickCount));
    GCCloseClientSend(aIndex, 0);
    return;
  }

  if (lpObj->Connected == OBJECT_ONLINE && gServerInfo.m_CheckSpeedHack != 0 &&
      lpMsg->PhysiSpeed > lpObj->PhysiSpeed &&
      abs((int)(lpObj->PhysiSpeed - lpMsg->PhysiSpeed)) >
          gServerInfo.m_CheckSpeedHackTolerance) {
    gLog.Output(LOG_HACK, "[%s][%s] Client Speed Hack Detected [%d][%d]",
                lpObj->Account, lpObj->Name, lpObj->PhysiSpeed,
                lpMsg->PhysiSpeed);
    GCCloseClientSend(aIndex, 0);
    return;
  }
  ...
  if (lpObj->Connected == OBJECT_ONLINE && gServerInfo.m_CheckSpeedHack != 0 &&
      lpMsg->MagicSpeed > lpObj->MagicSpeed &&
      abs((int)(lpObj->MagicSpeed - lpMsg->MagicSpeed)) >
          gServerInfo.m_CheckSpeedHackTolerance) {
    gLog.Output(LOG_HACK, "[%s][%s] Client Speed Hack Detected [%d][%d]",
                lpObj->Account, lpObj->Name, lpObj->MagicSpeed,
                lpMsg->MagicSpeed);
    GCCloseClientSend(aIndex, 0);
    return;
  }
...
void CGPositionRecv(PMSG_POSITION_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (CC_MAP_RANGE(lpObj->Map) != 0 &&
      (GetTickCount() - lpObj->ChaosCastleBlowTime) < 1000) {
    return;
  }

  if (lpMsg->x < (lpObj->X - 15) || lpMsg->x > (lpObj->X + 15) ||
      lpMsg->y < (lpObj->Y - 15) || lpMsg->y > (lpObj->Y + 15)) {
    return;
  }

#if (CUSTOM_CHANGEITEM)
  if (lpObj->Interface.use != 0 &&
      lpObj->Interface.type == INTERFACE_CHANGEITEM) {
    gCustomChangeItem.SetStateInterface(aIndex, 0);
  }
#endif
...
void CGCharacterOffRecv(PMSG_CHARACTER_OFF_RECV *lpMsg, int aIndex) {
  ...
  if (lpMsg->State == 0) {
    ...
    lpObj->PShopCustomTime =
        (gCustomStore.m_CustomStoreTime[lpObj->AccountLevel] * 60);
...
void CGEventRemainTimeRecv(PMSG_EVENT_REMAIN_TIME_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (lpMsg->EventType == 4) {
    ...
    lpMsg->ItemLevel =
        ((lpMsg->EventType == 2) ? lpMsg->ItemLevel : (lpMsg->ItemLevel - 1));
  }
    ...
    if (IT_LEVEL_RANGE(lpMsg->ItemLevel) != 0) {
      if (gIllusionTemple.GetState(lpMsg->ItemLevel) == IT_STATE_EMPTY) {
        if (gIllusionTemple.GetEnterEnabled(lpMsg->ItemLevel) == 0) {
          ...
          pMsg.EnteredUser =
              gIllusionTemple.GetEnteredUserCount(lpMsg->ItemLevel);
        }
      } else {
        pMsg.RemainTimeH = gIllusionTemple.GetRemainTime(lpMsg->ItemLevel);
      }
...
void CGPetItemInfoRecv(PMSG_PET_ITEM_INFO_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (lpMsg->flag == 0) // Inventory
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpObj->Inventory[lpMsg->slot].m_PetItemLevel,
                      lpObj->Inventory[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpObj->Inventory[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 1) // Warehouse
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpObj->Warehouse[lpMsg->slot].m_PetItemLevel,
                      lpObj->Warehouse[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpObj->Warehouse[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 2) // Trade
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpObj->Trade[lpMsg->slot].m_PetItemLevel,
                      lpObj->Trade[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpObj->Trade[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 3) // Target Trade
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpTarget->Trade[lpMsg->slot].m_PetItemLevel,
                      lpTarget->Trade[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpTarget->Trade[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 4) // Chaos Box
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpObj->ChaosBox[lpMsg->slot].m_PetItemLevel,
                      lpObj->ChaosBox[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpObj->ChaosBox[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 5) // Target Personal Shop
  {
    ...
    GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                      lpTarget->Inventory[lpMsg->slot].m_PetItemLevel,
                      lpTarget->Inventory[lpMsg->slot].m_PetItemExp,
                      (BYTE)lpTarget->Inventory[lpMsg->slot].m_Durability);
  } else if (lpMsg->flag == 6) // shop normal
  {
    ...
    if (lpObj->TargetShopNumber != -1) {
      ...
      if (ShopInventory) {
        GCPetItemInfoSend(aIndex, lpMsg->type, lpMsg->flag, lpMsg->slot,
                          ShopInventory[lpMsg->slot].m_PetItemLevel,
                          ShopInventory[lpMsg->slot].m_PetItemExp,
                          (BYTE)ShopInventory[lpMsg->slot].m_Durability);
      }
    }
  }
}

void CGMapServerMoveAuthRecv(PMSG_MAP_SERVER_MOVE_AUTH_RECV *lpMsg,
                             int aIndex) // OK
{
  LPOBJ lpObj = &gObj[aIndex];
  ...
  if (memcmp(gServerInfo.m_ServerVersion, lpMsg->ClientVersion,
             sizeof(lpMsg->ClientVersion)) != 0) {
    GCMapServerMoveAuthSend(aIndex, 6);
    return;
  }

  if (memcmp(gServerInfo.m_ServerSerial, lpMsg->ClientSerial,
             sizeof(lpMsg->ClientSerial)) != 0) {
    GCMapServerMoveAuthSend(aIndex, 6);
    return;
  }
  ...
  if (lpObj->LoginMessageSend == 0) {
    ...
    GJMapServerMoveAuthSend(aIndex, account, lpMsg->name, lpMsg->AuthCode1,
                            lpMsg->AuthCode2, lpMsg->AuthCode3,
                            lpMsg->AuthCode4);
  }
}
...
void CGMoveRecv(PMSG_MOVE_RECV *lpMsg, int aIndex) // OK
{
  ...
  lpObj->PathCount =
      ((lpObj->PathCount > 0) ? (lpObj->PathCount + 1) : lpObj->PathCount);
  ...
  for (int n = 1; n < lpObj->PathCount; n++) {
    if ((n % 2) == 0) {
      lpObj->TX = lpObj->PathX[n - 1] +
                  RoadPathTable[((lpMsg->path[((n + 1) / 2)] & 0x0F) * 2) + 0];
      lpObj->TY = lpObj->PathY[n - 1] +
                  RoadPathTable[((lpMsg->path[((n + 1) / 2)] & 0x0F) * 2) + 1];
      lpObj->PathX[n] =
          lpObj->PathX[n - 1] +
          RoadPathTable[((lpMsg->path[((n + 1) / 2)] & 0x0F) * 2) + 0];
      lpObj->PathY[n] =
      ...
      lpObj->TX = lpObj->PathX[n - 1] +
                  RoadPathTable[((lpMsg->path[((n + 1) / 2)] / 0x10) * 2) + 0];
      lpObj->TY = lpObj->PathY[n - 1] +
                  RoadPathTable[((lpMsg->path[((n + 1) / 2)] / 0x10) * 2) + 1];
      lpObj->PathX[n] =
          lpObj->PathX[n - 1] +
          RoadPathTable[((lpMsg->path[((n + 1) / 2)] / 0x10) * 2) + 0];
      lpObj->PathY[n] =
  ...
  if (lpObj->TX < (lpObj->X - 15) || lpObj->TX > (lpObj->X + 15) ||
      lpObj->TY < (lpObj->Y - 15) || lpObj->TY > (lpObj->Y + 15)) {
    lpObj->PathCur = 0;
    lpObj->PathCount = 0;
  ...
  if (lpObj->PathCount > 0 &&
      (gMap[lpObj->Map].CheckAttr(lpObj->TX, lpObj->TY, 4) != 0 ||
       gMap[lpObj->Map].CheckAttr(lpObj->TX, lpObj->TY, 8) != 0)) {
    lpObj->PathCur = 0;
    lpObj->PathCount = 0;
    lpObj->PathStartEnd = 0;
    memset(lpObj->PathX, 0, sizeof(lpObj->PathX));
...
void CGConnectAccountRecv(PMSG_CONNECT_ACCOUNT_RECV *lpMsg, int aIndex) // OK
{
  ...
  PacketArgumentDecrypt(HardwareId, lpMsg->ComputerHardwareId,
                        (sizeof(HardwareId) - 1));
  ...
  if (lpObj->LoginMessageSend == 0) {
    ...
    for (int i = OBJECT_START_USER; i < MAX_OBJECT; i++) {
      ...
      if (sObj->Connected == OBJECT_ONLINE) {
        if (account[0] == sObj->Account[0]) {
          if (strncmp(account, sObj->Account, 10) == 0) {
    ...
    lpObj->DestX = 0;
    lpObj->DestY = 0;
    strcpy_s(lpObj->Password, password);
...
void CGCharacterCreateRecv(PMSG_CHARACTER_CREATE_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (lpMsg->Class != DB_CLASS_DW && lpMsg->Class != DB_CLASS_DK &&
      lpMsg->Class != DB_CLASS_FE && lpMsg->Class != DB_CLASS_MG &&
      lpMsg->Class != DB_CLASS_DL && lpMsg->Class != DB_CLASS_SU &&
      lpMsg->Class != DB_CLASS_RF && lpMsg->Class != DB_CLASS_GL &&
      lpMsg->Class != DB_CLASS_RW && lpMsg->Class != DB_CLASS_SL &&
      lpMsg->Class != DB_CLASS_GC && lpMsg->Class != DB_CLASS_KUM &&
      lpMsg->Class != DB_CLASS_LEM && lpMsg->Class != DB_CLASS_KIN) {
    DataSend(aIndex, (BYTE *)&pMsg, pMsg.header.size);
    return;
  }
...
void CGLevelUpPointRecv(PMSG_LEVEL_UP_POINT_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (gObjectManager.CharacterLevelUpPointAdd(lpObj, lpMsg->type, 1) != 0) {
    ...
    case 2: // Vitality
      pMsg.MaxLifeAndMana =
          GET_MAX_WORD_VALUE((lpObj->MaxLife + lpObj->AddLife));
      break;
    case 3: // Energy
      pMsg.MaxLifeAndMana =
          GET_MAX_WORD_VALUE((lpObj->MaxMana + lpObj->AddMana));
      break;
    }
    ...
    pMsg.ViewMaxHP =
        GetProtocolDwordValueFromDouble(lpObj->MaxLife + lpObj->AddLife);
...
void CGCharacterNameCheckRecv(PMSG_CHARACTER_NAME_CHECK_RECV *lpMsg,
                              int aIndex) // OK
{
#if (GAMESERVER_UPDATE >= 401)
...
void CGCharacterNameChangeRecv(PMSG_CHARACTER_NAME_CHANGE_RECV *lpMsg,
                               int aIndex) // OK
{
#if (GAMESERVER_UPDATE >= 401)
...
void CGOptionChangeSkinRecv(PMSG_OPTION_CHANGE_SKIN_RECV *lpMsg,
                            int aIndex) // OK
{
#if (GAMESERVER_UPDATE >= 701)
...
void CGOptionDataRecv(PMSG_OPTION_DATA_RECV *lpMsg, int aIndex) // OK
{
  ...
  if (lpObj->RenameActive == 0) {
    GDOptionDataSaveSend(
        aIndex, lpMsg->SkillKey, lpMsg->GameOption, lpMsg->QKey, lpMsg->WKey,
        lpMsg->EKey, lpMsg->ChatWindow, lpMsg->RKey, ntohl(lpMsg->QWERLevel));
  }
}

void CGClientSecurityBreachRecv(PMSG_CLIENT_SECURITY_BREACH_RECV *lpMsg,
                                int aIndex) // OK
{
#if (GAMESERVER_UPDATE >= 701)
  ...
  gLog.Output(LOG_HACK, "[ClientSecurityBreach][%s][%s] (Code: %d)",
              lpObj->Account, lpObj->Name,
              MAKE_NUMBERDW(MAKE_NUMBERW(lpMsg->code[0], lpMsg->code[1]),
                            MAKE_NUMBERW(lpMsg->code[2], lpMsg->code[3])));
...
void CGSNSDataLogRecv(PMSG_SNS_DATA_LOG_RECV *lpMsg, int aIndex) // OK
{
  ...
  LogAdd(LOG_BLACK, "[SNSDataLog][%s][%s] - (Code: %d/%d/%d)", lpObj->Account,
         lpObj->Name, lpMsg->code[0], lpMsg->code[1], lpMsg->code[2]);
...
void GCChatTargetSend(LPOBJ lpObj, int aIndex, char *message, ...) // OK
{
  ...
  int size = (int)strnlen(buff, MAX_MESSAGE_SIZE - 1);
...
//
//	size = ((size > MAX_CHAT_MESSAGE_SIZE-1) ? MAX_CHAT_MESSAGE_SIZE-1 :
// size);
//
//	PMSG_CHAT_TARGET_SEND pMsg;
//
//	pMsg.header.set(0x01, (sizeof(pMsg) - (sizeof(pMsg.message) - (size +
// 1))));
//
//	pMsg.index[0] = SET_NUMBERHB(aIndex);
//
...
void GCChatWhisperSend(int aIndex, char *name, char *message) // OK
{
  ...
  size =
      ((size > MAX_CHAT_MESSAGE_SIZE - 1) ? MAX_CHAT_MESSAGE_SIZE - 1 : size);
...
void GCMainCheckSend(int aIndex) // OK
{
  ...
  pMsg.key =
      (((GetLargeRand() % 64) * 16) | ((lpObj->CheckSumTableNum & 0x3F0) * 64) |
       ((lpObj->CheckSumTableNum & 0x0F)) ^ 0xB479);
...
void GCDamageSend(int aIndex, int bIndex, BYTE flag, QWORD damage, int type,
                  QWORD ShieldDamage) // OK
{
  PMSG_DAMAGE_SEND pMsg;
  DWORD ViewDamage = GetProtocolDwordValueFromQword(damage);
  DWORD ViewShieldDamage = GetProtocolDwordValueFromQword(ShieldDamage);
  ...
  pMsg.damage[0] = SET_NUMBERHB(GET_MAX_WORD_VALUE(ViewDamage));
  pMsg.damage[1] = SET_NUMBERLB(GET_MAX_WORD_VALUE(ViewDamage));
  ...
  pMsg.ShieldDamage[0] = SET_NUMBERHB(GET_MAX_WORD_VALUE(ViewShieldDamage));
  pMsg.ShieldDamage[1] = SET_NUMBERLB(GET_MAX_WORD_VALUE(ViewShieldDamage));
...
#if (GAMESERVER_EXTRA == 1)
  pMsg.ViewCurHP = GetProtocolDwordValueFromDouble(gObj[bIndex].Life);
  pMsg.ViewCurSD = GetProtocolDwordValueFromDouble(gObj[bIndex].Shield);
  pMsg.ViewDamageHP = ViewDamage;
  pMsg.ViewDamageSD = ViewShieldDamage;
#endif
...
void GCLifeSend(int aIndex, BYTE type, double life, double shield) // OK
{
  PMSG_LIFE_SEND pMsg;
  DWORD ViewLife = GetProtocolDwordValueFromDouble(life);
  DWORD ViewShield = GetProtocolDwordValueFromDouble(shield);

  pMsg.header.set(0x26, sizeof(pMsg));

  pMsg.type = type;

  pMsg.life[0] = SET_NUMBERHB(GET_MAX_WORD_VALUE(ViewLife));
  pMsg.life[1] = SET_NUMBERLB(GET_MAX_WORD_VALUE(ViewLife));

  pMsg.flag = 0;

  pMsg.shield[0] = SET_NUMBERHB(GET_MAX_WORD_VALUE(ViewShield));
  pMsg.shield[1] = SET_NUMBERLB(GET_MAX_WORD_VALUE(ViewShield));

#if (GAMESERVER_EXTRA == 1)
  pMsg.ViewHP = ViewLife;
  pMsg.ViewSD = ViewShield;
#endif
...
void GCMapAttrSend(int aIndex, BYTE type, BYTE attr, BYTE flag, BYTE count,
                   PMSG_MAP_ATTR *lpInfo) // OK
{
  BYTE send[256];
...
void GCMonsterDieSend(int aIndex, int bIndex, int experience, QWORD damage,
                      BYTE flag) // OK
{
...
void GCPetItemInfoSend(int aIndex, BYTE type, BYTE flag, BYTE slot, BYTE level,
                       DWORD experience, BYTE durability) // OK
{
...
void GCMonsterAreaSkillSend(int aIndex, int MonsterClass, int sx, int sy,
                            int tx, int ty) // OK
{
...
void GCElementalDamageSend(int aIndex, int bIndex, BYTE attribute,
                           QWORD damage) // OK
{
#if (GAMESERVER_UPDATE >= 701)
  ...
  pMsg.damage = GetProtocolDwordValueFromQword(damage);
...
void GCLifeUpdateSend(LPOBJ pPlayer) // OK
{
  ...
  player_body.MaxHP =
      GetProtocolDwordValueFromDouble(pPlayer->MaxLife + pPlayer->AddLife);
  player_body.CurHP = GetProtocolDwordValueFromDouble(pPlayer->Life);
  // pMsg.index[0] = SET_NUMBERHB(lpObj->Index);
  // pMsg.index[1] = SET_NUMBERLB(lpObj->Index);
  // pMsg.MaxHP[0] = SET_NUMBERHB(SET_NUMBERHW((lpObj->MaxLife +
  // lpObj->AddLife))); pMsg.MaxHP[1] =
  // SET_NUMBERHB(SET_NUMBERLW((lpObj->MaxLife + lpObj->AddLife)));
  // pMsg.MaxHP[2] = SET_NUMBERLB(SET_NUMBERHW((lpObj->MaxLife +
  // lpObj->AddLife))); pMsg.MaxHP[3] =
  // SET_NUMBERLB(SET_NUMBERLW((lpObj->MaxLife + lpObj->AddLife)));
...
void GCCharacterRegenSend(LPOBJ lpObj) // OK
{
  ...
  if (gMasterSkillTree.CheckMasterLevel(lpObj) == 0) {
    pMsg.Experience[0] =
        SET_NUMBERHB(SET_NUMBERHW(SET_NUMBERHDW(lpObj->Experience)));
    pMsg.Experience[1] =
        SET_NUMBERLB(SET_NUMBERHW(SET_NUMBERHDW(lpObj->Experience)));
    pMsg.Experience[2] =
        SET_NUMBERHB(SET_NUMBERLW(SET_NUMBERHDW(lpObj->Experience)));
    pMsg.Experience[3] =
        SET_NUMBERLB(SET_NUMBERLW(SET_NUMBERHDW(lpObj->Experience)));
    pMsg.Experience[4] =
        SET_NUMBERHB(SET_NUMBERHW(SET_NUMBERLDW(lpObj->Experience)));
    pMsg.Experience[5] =
        SET_NUMBERLB(SET_NUMBERHW(SET_NUMBERLDW(lpObj->Experience)));
    pMsg.Experience[6] =
        SET_NUMBERHB(SET_NUMBERLW(SET_NUMBERLDW(lpObj->Experience)));
    pMsg.Experience[7] =
        SET_NUMBERLB(SET_NUMBERLW(SET_NUMBERLDW(lpObj->Experience)));
  } else {
    pMsg.Experience[0] =
        SET_NUMBERHB(SET_NUMBERHW(SET_NUMBERHDW(lpObj->MasterExperience)));
    pMsg.Experience[1] =
        SET_NUMBERLB(SET_NUMBERHW(SET_NUMBERHDW(lpObj->MasterExperience)));
    pMsg.Experience[2] =
        SET_NUMBERHB(SET_NUMBERLW(SET_NUMBERHDW(lpObj->MasterExperience)));
    pMsg.Experience[3] =
        SET_NUMBERLB(SET_NUMBERLW(SET_NUMBERHDW(lpObj->MasterExperience)));
    pMsg.Experience[4] =
        SET_NUMBERHB(SET_NUMBERHW(SET_NUMBERLDW(lpObj->MasterExperience)));
    pMsg.Experience[5] =
        SET_NUMBERLB(SET_NUMBERHW(SET_NUMBERLDW(lpObj->MasterExperience)));
    pMsg.Experience[6] =
        SET_NUMBERHB(SET_NUMBERLW(SET_NUMBERLDW(lpObj->MasterExperience)));
    pMsg.Experience[7] =
        SET_NUMBERLB(SET_NUMBERLW(SET_NUMBERLDW(lpObj->MasterExperience)));
  }

  pMsg.Money = lpObj->Money;

#if (GAMESERVER_EXTRA == 1)
  pMsg.ViewCurHP = GetProtocolDwordValueFromDouble(lpObj->Life);
  pMsg.ViewCurMP = (DWORD)(lpObj->Mana);
  pMsg.ViewCurBP = (DWORD)(lpObj->BP);
  pMsg.ViewCurSD = GetProtocolDwordValueFromDouble(lpObj->Shield);
#endif
...
void GCMonsterDamageSend(int aIndex, QWORD damage, QWORD ShieldDamage) // OK
{
...
#if (GAMESERVER_EXTRA == 1)
  pMsg.ViewCurHP = GetProtocolDwordValueFromDouble(gObj[aIndex].Life);
  pMsg.ViewCurSD = GetProtocolDwordValueFromDouble(gObj[aIndex].Shield);
  pMsg.ViewDamageHP = ViewDamage;
  pMsg.ViewDamageSD = ViewShieldDamage;
#endif
...
void GCNewCharacterCalcSend(LPOBJ lpObj) // OK
{
  ...
  gAttack.GetPreviewPhysiDamage(
      lpObj, &pMsg.ViewPhysiDamageMin, &pMsg.ViewPhysiDamageMax,
      &pMsg.ViewMulPhysiDamage, &pMsg.ViewDivPhysiDamage);

  gAttack.GetPreviewMagicDamage(
      lpObj, &pMsg.ViewMagicDamageMin, &pMsg.ViewMagicDamageMax,
      &pMsg.ViewMulMagicDamage, &pMsg.ViewDivMagicDamage,
      &pMsg.ViewMagicDamageRate);

  gAttack.GetPreviewCurseDamage(
      lpObj, &pMsg.ViewCurseDamageMin, &pMsg.ViewCurseDamageMax,
      &pMsg.ViewMulCurseDamage, &pMsg.ViewDivCurseDamage,
      &pMsg.ViewCurseDamageRate);
  ...
  pMsg.ViewAttackSuccessRate +=
      (pMsg.ViewAttackSuccessRate * lpObj->EffectOption.MulAttackSuccessRate) /
      100;

  pMsg.ViewAttackSuccessRate -=
      (pMsg.ViewAttackSuccessRate * lpObj->EffectOption.DivAttackSuccessRate) /
      100;
  ...
  pMsg.ViewDefenseSuccessRate += (pMsg.ViewDefenseSuccessRate *
                                  lpObj->EffectOption.MulDefenseSuccessRate) /
                                 100;

  pMsg.ViewDefenseSuccessRate -= (pMsg.ViewDefenseSuccessRate *
                                  lpObj->EffectOption.DivDefenseSuccessRate) /
                                 100;

  pMsg.ViewDefenseSuccessRatePvP = lpObj->DefenseSuccessRatePvP;

  gAttack.GetPreviewDamageMultiplier(
      lpObj, &pMsg.ViewDamageMultiplier, &pMsg.ViewRFDamageMultiplierA,
      &pMsg.ViewRFDamageMultiplierB, &pMsg.ViewRFDamageMultiplierC);

  gDarkSpirit[lpObj->Index].GetPreviewAttackDamage(
      lpObj, &pMsg.ViewDarkSpiritAttackDamageMin,
      &pMsg.ViewDarkSpiritAttackDamageMax, &pMsg.ViewDarkSpiritAttackSpeed,
      &pMsg.ViewDarkSpiritAttackSuccessRate);
...
void GCNewHealthBarSend(LPOBJ lpObj) // OK
{
  ...
  if (gServerInfo.m_MonsterHealthBarSwitch == 0 &&
      gServerInfo.m_UserHealthBarSwitch == 0) {
    return;
  }
  ...
  for (int n = 0; n < MAX_VIEWPORT; n++) {
    ...
    if (lpObj->VpPlayer[n].type == OBJECT_MONSTER &&
        gServerInfo.m_MonsterHealthBarSwitch == 0) {
      continue;
    }
    ...
    if (lpTarget->Live == 0 || lpTarget->State != OBJECT_PLAYING ||
        OBJECT_RANGE(lpTarget->SummonIndex) != 0 ||
    ...
    info.rate = (BYTE)((lpTarget->Life * 100) /
                       (lpTarget->MaxLife + lpTarget->AddLife));

    if (lpObj->VpPlayer[n].type == OBJECT_USER) {
      info.rate2 = (BYTE)((lpTarget->Shield * 100) /
                          (lpTarget->MaxShield + lpTarget->AddShield));
    } else {
      info.rate2 = 0;
    }
...
void GCAnsCastleSiegeState(int iIndex, int iResult, LPSTR lpszGuildName,
                           LPSTR lpszGuildMaster) {
#if (GAMESERVER_TYPE == 1)
  ...
  memcpy(pMsgResult.cOwnerGuildMaster, lpszGuildMaster,
         sizeof(pMsgResult.cOwnerGuildMaster));
  ...
  int bRETVAL =
      gCastleSiege.GetCastleStateTerm(&tmStateStartDate, &tmStateEndDate);
...
void GCAnsRegCastleSiege(int iIndex, int iResult, LPSTR lpszGuildName) {
  ...
  pMsgResult.btResult = iResult;
  memcpy(&pMsgResult.szGuildName, lpszGuildName,
         sizeof(pMsgResult.szGuildName));
  ...
  if (::gObjIsConnected(iIndex)) {
    LogAdd(
        LOG_BLACK,
        "[CastleSiege] [%s][%s] Registered Castle Siege (GUILD:%s) - Result:%d",
        gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
        iResult);
  }
#endif
}
...
void CGReqGiveUpCastleSiege(PMSG_REQ_GIVEUPCASTLESIEGE *lpMsg, int iIndex) {
#if (GAMESERVER_TYPE == 1)
  if ((gCastleSiege.GetCastleState() < CASTLESIEGE_STATE_REGSIEGE) ||
      (gCastleSiege.GetCastleState() > CASTLESIEGE_STATE_REGMARK)) // Fixed
  {
  ...
  GS_GDReqGuildSetGiveUp(gMapServerManager.GetMapServerGroup(), iIndex,
                         lpMsg->btGiveUp);
#endif
}

void GCAnsGiveUpCastleSiege(int iIndex, int iResult, int bGiveUp,
                            int iMarkCount, LPSTR lpszGuildName) {
#if (GAMESERVER_TYPE == 1)
  ...
  if (gObjIsConnected(iIndex)) {
    LogAdd(LOG_BLACK,
           "[CastleSiege] [%s][%s] GiveUp Castle Siege (GUILD:%s) - Result:%d",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           iResult);
  }
#endif
...
void GCAnsGuildRegInfo(int iIndex, int iResult,
                       CSP_ANS_GUILDREGINFO *lpMsgResult) {
#if (GAMESERVER_TYPE == 1)
  ...
  pMsgResult.btResult = iResult;
  pMsgResult.btGuildMark1 =
      SET_NUMBERHB(SET_NUMBERHW(lpMsgResult->iRegMarkCount));
  pMsgResult.btGuildMark2 =
      SET_NUMBERLB(SET_NUMBERHW(lpMsgResult->iRegMarkCount));
  pMsgResult.btGuildMark3 =
      SET_NUMBERHB(SET_NUMBERLW(lpMsgResult->iRegMarkCount));
  pMsgResult.btGuildMark4 =
      SET_NUMBERLB(SET_NUMBERLW(lpMsgResult->iRegMarkCount));
  pMsgResult.btRegRank = lpMsgResult->btRegRank;
  pMsgResult.btIsGiveUp = lpMsgResult->bIsGiveUp;
  memcpy(&pMsgResult.szGuildName, lpMsgResult->szGuildName,
         sizeof(pMsgResult.szGuildName));
  ...
  if (lpMsg->btItemPos < 0 || lpMsg->btItemPos >= 64) {
    ...
    if (gObj[iIndex].Inventory[iItemPos].IsItem() == FALSE) {
      ...
      if (gObj[iIndex].Inventory[iItemPos].m_Index != GET_ITEM(14, 21) ||
        ...
        GS_GDReqRegGuildMark(gMapServerManager.GetMapServerGroup(), iIndex,
                             iItemPos);
      }
    }
  }
...
void GCAnsRegGuildMark(int iIndex, int iResult,
                       CSP_ANS_GUILDREGMARK *lpMsgResult) {
#if (GAMESERVER_TYPE == 1)
  if (lpMsgResult == NULL) {
    return;
  }
  ...
  if (gObj[iIndex].Inventory[lpMsgResult->iItemPos].IsItem() == FALSE) {
    ...
    if (gObj[iIndex].Inventory[lpMsgResult->iItemPos].m_Index !=
                GET_ITEM(14, 21) &&
      ...
      if ((gObj[iIndex].Inventory[lpMsgResult->iItemPos].m_Durability -= 1.0) >
          0.0f) {
        gItemManager.GCItemDurSend(
            iIndex, lpMsgResult->iItemPos,
            (BYTE)gObj[iIndex].Inventory[lpMsgResult->iItemPos].m_Durability,
            0);
      } else {
...
void CGReqNpcBuy(PMSG_REQ_NPCBUY *lpMsg, int iIndex) {
  ...
  if (gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE ||
      (gObj[iIndex].GuildStatus != G_MASTER &&
       gObj[iIndex].GuildStatus != G_SUB_MASTER)) {
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqNpcBuy() ERROR - Authority Fail [%s][%s], "
           "Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
  } else {
    BYTE btResult = 0;

    BOOL bRETVAL = gCastleSiege.CheckAddDbNPC(iIndex, lpMsg->iNpcNumber,
                                              lpMsg->iNpcIndex, btResult);

    if (bRETVAL == FALSE) {
      GCAnsNpcBuy(iIndex, btResult, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
      LogAdd(
          LOG_RED,
          "[CastleSiege] CGReqNpcBuy() ERROR - CCastleSiege::CheckAddDbNPC() "
          "[%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
          gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
          gObj[iIndex].GuildStatus, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
    } else {
      LogAdd(LOG_RED,
             "[CastleSiege] CGReqNpcBuy() OK - [%s][%s], Guild:(%s)(%d), "
             "Npc:(CLS:%d, IDX:%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
    }
...
void CGReqNpcRepair(PMSG_REQ_NPCREPAIR *lpMsg, int iIndex) {
  ...
  if ((gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE) ||
      (gObj[iIndex].GuildStatus != G_MASTER) &&
          (gObj[iIndex].GuildStatus != G_SUB_MASTER)) {
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqNpcRepair() ERROR - Authority Fail [%s][%s], "
           "Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
  ...
  bRETVAL =
      gCastleSiege.GetNpcData(lpMsg->iNpcNumber, lpMsg->iNpcIndex, pNpcData);

  if (bRETVAL == FALSE) {
    GCAnsNpcRepair(iIndex, 0, lpMsg->iNpcNumber, lpMsg->iNpcIndex, 0, 0);
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqNpcRepair() ERROR - CL Request Fail [%s][%s], "
           "Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus, lpMsg->iNpcNumber, lpMsg->iNpcIndex);
    return;
    ...
    if (gObjIsConnected(iNpcIndex) == FALSE) {
      GCAnsNpcRepair(iIndex, 0, lpMsg->iNpcNumber, lpMsg->iNpcIndex, 0, 0);
      LogAdd(LOG_RED,
             "[CastleSiege] CGReqNpcRepair() ERROR - Npc Alive Data Mismatch "
             "[%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus, pNpcData.m_iNPC_NUM,
      ...
      if ((gObj[iNpcIndex].MaxLife == gObj[iNpcIndex].Life) ||
        ...
        case 277:
          iRepairCost =
              (int)(float((gObj[iNpcIndex].MaxLife - gObj[iNpcIndex].Life) *
                          0.5f) +
                    float(gObj[iNpcIndex].CsNpcDfLevel * 1000000));
          break;
        case 283:
          iRepairCost =
              (int)((gObj[iNpcIndex].MaxLife - gObj[iNpcIndex].Life) * 0.3f +
                    float((gObj[iNpcIndex].CsNpcDfLevel +
                           gObj[iNpcIndex].CsNpcRgLevel) *
                          1000000));
          break;
        default:
          GCAnsNpcRepair(iIndex, 0, lpMsg->iNpcNumber, lpMsg->iNpcIndex, 0, 0);
        ...
        if (gObj[iIndex].Money < ((DWORD)iRepairCost)) {
          ...
          LogAdd(LOG_RED,
                 "[CastleSiege] CGReqNpcRepair() ERROR - Money isn't enough "
                 "[%s][%s], Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
                 gObj[iIndex].Account, gObj[iIndex].Name,
                 gObj[iIndex].GuildName, gObj[iIndex].GuildStatus,
                 pNpcData.m_iNPC_NUM, pNpcData.m_iNPC_INDEX);
          return;
        } else {
          LogAdd(LOG_RED,
                 "[CastleSiege] CGReqNpcRepair() OK - [%s][%s], "
                 "Guild:(%s)(%d), Npc:(CLS:%d, IDX:%d)",
                 gObj[iIndex].Account, gObj[iIndex].Name,
                 gObj[iIndex].GuildName, gObj[iIndex].GuildStatus,
                 pNpcData.m_iNPC_NUM, pNpcData.m_iNPC_INDEX);
          GS_GDReqCastleNpcRepair(gMapServerManager.GetMapServerGroup(), iIndex,
...
void GCAnsNpcRepair(int iIndex, int iResult, int iNpcNumber, int iNpcIndex,
                    int iNpcHP, int iNpcMaxHP) {
#if (GAMESERVER_TYPE == 1)
...
void CGReqNpcUpgrade(PMSG_REQ_NPCUPGRADE *lpMsg, int iIndex) {
  ...
  if ((gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE) ||
      (gObj[iIndex].GuildStatus != G_MASTER)) {
    LogAdd(LOG_BLACK,
           "[CastleSiege] CGReqNpcUpgrade() ERROR - Authority Fail [%s][%s], "
           "Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus);
    return;
  ...
  case 277: {
    ...
    BOOL bResult =
        gCastleSiege.GetNpcData(lpMsg->iNpcNumber, lpMsg->iNpcIndex, m_NpcData);
    ...
    if (bResult) {
      ...
      case 1: {
        ...
        if ((iNXT_UPLVL >= 1) && (iNXT_UPLVL <= 3) &&
            (iNXT_UPLVL == (iCUR_UPLVL + 1))) {
      ...
      default: {
        GCAnsNpcUpgrade(iIndex, 5, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                        lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
        return;
      } break;
      }
    } else {
      GCAnsNpcUpgrade(iIndex, 7, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                      lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
      return;
    }
  } break;
  case 283: {
    ...
    if (bResult) {
      ...
      default: {
        ...
        LogAdd(
            LOG_BLACK,
            "[CastleSiege] CGReqNpcUpgrade() ERROR - UpType doesn't Exist "
            "[%s][%s], Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d",
            gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
            gObj[iIndex].GuildNumber, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
            lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
        return;
      } break;
      }
  ...
  if (bENABLE_UPGRADE == FALSE) {
    GCAnsNpcUpgrade(iIndex, 6, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                    lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
  } else {
    if (gObj[iIndex].Money < ((DWORD)iNEED_MONEY)) {
      GCAnsNpcUpgrade(iIndex, 3, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                      lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqNpcUpgrade() ERROR - Money is Low [%s][%s], "
             "Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, "
             "NXTLV:%d, Money:%d, Need Money:%d",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildNumber, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
             lpMsg->iNpcUpType, lpMsg->iNpcUpValue, iNXT_UPLVL,
      ...
      if (iGEMOFDEFEND_COUNT < iNEED_GEMOFDEFEND) {
        GCAnsNpcUpgrade(iIndex, 4, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                        lpMsg->iNpcUpType, lpMsg->iNpcUpValue);
        LogAdd(LOG_BLACK,
               "[CastleSiege] CGReqNpcUpgrade() ERROR - Gem is Low [%s][%s], "
               "Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, "
               "NXTLV:%d, Gem:%d, Need Gem:%d",
               gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
               gObj[iIndex].GuildNumber, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
               lpMsg->iNpcUpType, lpMsg->iNpcUpValue, iNXT_UPLVL,
               iGEMOFDEFEND_COUNT, iNEED_GEMOFDEFEND);
      } else {
        bRETVAL = gCastleSiege.PayForUpgradeDbNpc(
            iIndex, lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType,
            lpMsg->iNpcUpValue, (iNXT_UPLVL - 1));

        if (bRETVAL != FALSE) {
          gObj[iIndex].IsCastleNPCUpgradeCompleted = TRUE;
          LogAdd(LOG_BLACK,
                 "[CastleSiege] [0xB2][0x07] CGReqNpcUpgrade() - Pay For Npc "
                 "Upgrade (CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d)",
                 lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType,
                 iNXT_UPVALUE);
          GS_GDReqCastleNpcUpgrade(gMapServerManager.GetMapServerGroup(),
                                   iIndex, lpMsg->iNpcNumber, lpMsg->iNpcIndex,
                                   lpMsg->iNpcUpType, iNXT_UPVALUE,
                                   (iNXT_UPLVL - 1));
          LogAdd(LOG_BLACK,
                 "[CastleSiege] CGReqNpcUpgrade() REQ OK - [%s][%s], "
                 "Guild:(%s)(%d), NPC CLS:%d, IDX:%d, UPTYPE:%d, UPVAL:%d, "
                 "NXTLV:%d",
                 gObj[iIndex].Account, gObj[iIndex].Name,
                 gObj[iIndex].GuildName, gObj[iIndex].GuildNumber,
                 lpMsg->iNpcNumber, lpMsg->iNpcIndex, lpMsg->iNpcUpType,
                 lpMsg->iNpcUpValue, iNXT_UPLVL);
        }
      }
    }
  }
...
void GCAnsNpcUpgrade(int iIndex, int iResult, int iNpcNumber, int iNpcIndex,
                     int iNpcUpType, int iNpcUpValue) {
#if (GAMESERVER_TYPE == 1)
...
void CGReqTaxMoneyInfo(PMSG_REQ_TAXMONEYINFO *lpMsg, int iIndex) {
  ...
  if (lpMsg != NULL && strcmp(gObj[iIndex].GuildName, "") != 0) {
    if ((gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE) ||
        (gObj[iIndex].GuildStatus != G_MASTER)) {
      LogAdd(LOG_RED,
             "[CastleSiege] CGReqTaxMoneyInfo() ERROR - Authority Fail "
             "[%s][%s], Guild:(%s)(%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus);
    } else {
      ...
      LogAdd(
          LOG_RED,
          "[CastleSiege] CGReqTaxMoneyInfo() REQ OK - [%s][%s], Guild:(%s)(%d)",
          gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
          gObj[iIndex].GuildStatus);
    }
  }
...
void GCAnsTaxMoneyInfo(int iIndex, int iResult, BYTE btTaxRateChaos,
                       BYTE btTaxRateStore, __int64 i64Money) {
#if (GAMESERVER_TYPE == 1)
...
void CGReqTaxRateChange(PMSG_REQ_TAXRATECHANGE *lpMsg, int iIndex) {
  ...
  if ((gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE) ||
      (gObj[iIndex].GuildStatus != G_MASTER)) {
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqTaxRateChange() ERROR - Authority Fail "
           "[%s][%s], Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus);
  } else {
    ...
    iTaxRate =
        MAKE_NUMBERDW(MAKE_NUMBERW(lpMsg->btTaxRate1, lpMsg->btTaxRate2),
                      MAKE_NUMBERW(lpMsg->btTaxRate3, lpMsg->btTaxRate4));

    if ((iTaxRate < 0) || (iTaxRate > iMaxTaxRate)) {
      GCAnsTaxRateChange(iIndex, 0, 0, 0);
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqTaxRateChange() ERROR - Tax Rate Out of Range "
             "[%s][%s], Guild:(%s)(%d), TaxType:%d, TaxRate:%d",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus, lpMsg->btTaxType, iTaxRate);
    } else {
      GS_GDReqTaxRateChange(gMapServerManager.GetMapServerGroup(), iIndex,
                            lpMsg->btTaxType, iTaxRate);
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqTaxRateChange() REQ OK - [%s][%s], "
             "Guild:(%s)(%d), TaxType:%d, TaxRate:%d",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus, lpMsg->btTaxType, iTaxRate);
    }
  }
...
void CGReqMoneyDrawOut(PMSG_REQ_MONEYDRAWOUT *lpMsg, int iIndex) {
  ...
  if ((gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE) ||
      (gObj[iIndex].GuildStatus != G_MASTER)) {
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqMoneyDrawOut() ERROR - Authority Fail [%s][%s], "
           "Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus);
  } else {
    iMoneyChange =
        MAKE_NUMBERDW(MAKE_NUMBERW(lpMsg->btMoney4, lpMsg->btMoney3),
                      MAKE_NUMBERW(lpMsg->btMoney2, lpMsg->btMoney1));

    if (iMoneyChange <= 0) {
      GCAnsMoneyDrawOut(iIndex, 0, 0);
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqMoneyDrawOut() ERROR - Req Money < 0 "
             "[%s][%s], Guild:(%s)(%d), Money:%d, TotMoney:%d",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
      ...
      if (bRETVAL == FALSE) {
        GCAnsMoneyDrawOut(iIndex, 0, 0);
        LogAdd(LOG_BLACK,
               "[CastleSiege] CGReqMoneyDrawOut() ERROR - Castle Money is Low "
               "[%s][%s], Guild:(%s)(%d), Money:%d, TotMoney:%d",
               gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
               gObj[iIndex].GuildStatus, iMoneyChange, gObj[iIndex].Money);
      } else {
        if ((gObj[iIndex].Money + iMoneyChange) > MAX_MONEY) {
          ...
          GS_GDReqCastleMoneyChange(gMapServerManager.GetMapServerGroup(),
                                    iIndex, -iMoneyChange);
          LogAdd(LOG_BLACK,
                 "[CastleSiege] CGReqMoneyDrawOut() REQ OK - [%s][%s], "
                 "Guild:(%s)(%d), Money:%d, TotMoney:%d",
                 gObj[iIndex].Account, gObj[iIndex].Name,
                 gObj[iIndex].GuildName, gObj[iIndex].GuildStatus, iMoneyChange,
                 gObj[iIndex].Money);
        }
      }
    }
...
void CGReqCsGateOperate(PMSG_REQ_CSGATEOPERATE *lpMsg, int iIndex) {
  ...
  if (gCastleSiege.GetCastleState() == CASTLESIEGE_STATE_STARTSIEGE) {
    if (gObj[iIndex].CsJoinSide != 1) {
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqCsGateOperate() ERROR - Authority Fail "
             "[%s][%s], Guild:(%s)(%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus);
      return;
  ...
  if (gCastleSiege.CheckCsGateAlive(iGateIndex) == TRUE) {
    int iOperateGate = gCastleSiege.OperateGate(
        iGateIndex, gObj[iGateIndex].CsNpcExistVal, lpMsg->btOperate);

    if (iOperateGate == 0) {
      GCAnsCsGateOperate(iIndex, 0, -1, 0);
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqCsGateOperate() ERROR - Operate Gate Failed "
             "[%s][%s], Guild:(%s)(%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildStatus);
    } else {
      ...
      LogAdd(LOG_BLACK,
             "[CastleSiege] CGReqCsGateOperate() OK - [%s][%s], "
             "Guild:(%s)(%d), DOOR:(%d)(X:%d,Y:%d)(STATUE:%d)",
             gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
             gObj[iIndex].GuildNumber, iGateIndex, gObj[iGateIndex].X,
             gObj[iGateIndex].Y, gObj[iGateIndex].CsGateOpen);
    }
  } else {
    GCAnsCsGateOperate(iIndex, 2, -1, 0);
    LogAdd(LOG_BLACK,
           "[CastleSiege] CGReqCsGateOperate() ERROR - Gate Doesn't Exist "
           "[%s][%s], Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus);
  }
...
void GCAnsCsGateOperate(int iIndex, int iResult, int iGateIndex,
                        int iGateOperate) {
#if (GAMESERVER_TYPE == 1)
...
void GCAnsCsAccessSwitchState(int iIndex, int iSwitchIndex,
                              int iSwitchUserIndex, BYTE btSwitchState) {
#if (GAMESERVER_TYPE == 1)
...
void GCAnsCsAccessCrownState(int iIndex, BYTE btCrownState) {
  ...
  if (btCrownState == 0) {
    if (gObj[iIndex].AccumulatedCrownAccessTime < 0 ||
        gObj[iIndex].AccumulatedCrownAccessTime > 61000) {
      gObj[iIndex].AccumulatedCrownAccessTime = 0;
    }

    LogAdd(LOG_BLACK,
           "[CastleSiege] [Reg. Attempt] Accumulated Crown AccessTime : %d "
           "[%s](%s)(%s)",
           gObj[iIndex].AccumulatedCrownAccessTime, gObj[iIndex].GuildName,
           gObj[iIndex].Account, gObj[iIndex].Name);
  }

  if (btCrownState == 1) {
    LogAdd(LOG_BLACK,
           "[CastleSiege] [Reg. Success] Accumulated Crown AccessTime : %d "
           "[%s](%s)(%s)",
           gObj[iIndex].AccumulatedCrownAccessTime, gObj[iIndex].GuildName,
           gObj[iIndex].Account, gObj[iIndex].Name);
    gObj[iIndex].AccumulatedCrownAccessTime = 0;
  ...
  if (btCrownState == 2) {
    gObj[iIndex].AccumulatedCrownAccessTime +=
        GetTickCount() - gCastleSiege.GetCrownAccessTickCount();

    gObj[iIndex].AccumulatedCrownAccessTime -=
        gServerInfo.m_CastleSiegeLowerAccumulatedTimeValue;
    ...
    LogAdd(LOG_BLACK,
           "[CastleSiege] [Reg. Fail] Accumulated Crown AccessTime : %d "
           "[%s](%s)(%s)",
           gObj[iIndex].AccumulatedCrownAccessTime, gObj[iIndex].GuildName,
           gObj[iIndex].Account, gObj[iIndex].Name);
  }

  pMsgResult.dwAccumulatedCrownAccessTime =
      gObj[iIndex].AccumulatedCrownAccessTime;
...
void GCAnsCsNotifyProgress(int iIndex, BYTE btCastleSiegeState,
                           LPCSTR lpszGuildName) {
  if (lpszGuildName == NULL) {
    return;
  }
...
void CGReqCsMiniMapData(PMSG_REQ_MINIMAPDATA *lpMsg, int iIndex) {
  ...
  if ((gObj[iIndex].CsJoinSide <= 0) ||
      (gCastleSiege.CheckUnionGuildMaster(iIndex) == FALSE)) {
...
void CGReqCsSendCommand(PMSG_REQ_CSCOMMAND *lpMsg, int iIndex) {
  ...
  GCAnsCsSendCommand(gObj[iIndex].CsJoinSide, lpMsg->btTeam, lpMsg->btX,
                     lpMsg->btY, lpMsg->btCommand);
#endif
}

void GCAnsCsSendCommand(int iCsJoinSize, BYTE btTeam, BYTE btX, BYTE btY,
                        BYTE btCommand) {
#if (GAMESERVER_TYPE == 1)
  ...
  for (int iIndex = OBJECT_START_USER; iIndex < MAX_OBJECT; iIndex++) {
    ...
    if ((gObj[iIndex].CsJoinSide == iCsJoinSize) &&
        (gObj[iIndex].Map == MAP_CASTLE_SIEGE)) {
      DataSend(iIndex, (LPBYTE)&pMsgResult, pMsgResult.h.size);
    }
  }
#endif
...
void CGReqNpcDbList(PMSG_REQ_NPCDBLIST *lpMsg, int iIndex) {
  ...
  if (gCastleSiege.CheckGuildOwnCastle(gObj[iIndex].GuildName) == FALSE ||
      ((gObj[iIndex].GuildStatus != 128) && (gObj[iIndex].GuildStatus != 64))) {
    LogAdd(LOG_RED,
           "[CastleSiege] CGReqNpcDbList() ERROR - Authority Fail [%s][%s], "
           "Guild:(%s)(%d)",
           gObj[iIndex].Account, gObj[iIndex].Name, gObj[iIndex].GuildName,
           gObj[iIndex].GuildStatus);
...
void CGReqCsAttkGuildList(PMSG_REQ_CSATTKGUILDLIST *lpMsg, int iIndex) {
  ...
  lpMsgSendBody =
      (PMSG_CSATTKGUILDLIST *)(cBUFFER + sizeof(PMSG_ANS_CSATTKGUILDLIST));
  ...
  lpMsgSend->h.set(0xB5, ((lpMsgSend->iCount * sizeof(PMSG_CSATTKGUILDLIST)) +
                          sizeof(PMSG_ANS_CSATTKGUILDLIST)));
  DataSend(iIndex, (LPBYTE)lpMsgSend,
           ((lpMsgSend->iCount * sizeof(PMSG_CSATTKGUILDLIST)) +
            sizeof(PMSG_ANS_CSATTKGUILDLIST)));
#endif
}

void CGReqGuildMarkOfCastleOwner(PMSG_REQ_GUILDMARK_OF_CASTLEOWNER *aRecv,
                                 int iIndex) {
  ...
  if (szGuildName) {
    ...
    if (lpGuild != NULL) {
      ...
      memcpy(pMsg.GuildMarkOfCastleOwner, lpGuild->Mark,
             sizeof(pMsg.GuildMarkOfCastleOwner));
...
void CGReqCastleHuntZoneEntrance(PMSG_REQ_MOVE_TO_CASTLE_HUNTZONE *aRecv,
                                 int iIndex) {
#if (GAMESERVER_TYPE == 1)
  if (!OBJECT_RANGE(iIndex)) {
    return;
    ...
    if (lpObj->Money >= ((DWORD)iEnterTaxMoney)) {
      if (lpObj->Map == MAP_CASTLE_SIEGE) {
        if (gObjMoveGate(lpObj->Index, 95) == TRUE) {
          ...
          LogAdd(LOG_BLACK,
                 "[Castle HuntZone] [%s][%s] - Entrance TAX : %d - %d = %d",
                 lpObj->Account, lpObj->Name, iOldMoney, iEnterTaxMoney,
                 lpObj->Money);
        }
      }
    }
