...
void GCDamageSend(int aIndex,int bIndex,BYTE flag,QWORD damage,int type,QWORD ShieldDamage);
...
void GCLifeSend(int aIndex,BYTE type,double life,double shield);
...
void GCMonsterDieSend(int aIndex,int bIndex,int experience,QWORD damage,BYTE flag);
...
void GCElementalDamageSend(int aIndex,int bIndex,BYTE attribute,QWORD damage);
...
void GCMonsterDamageSend(int aIndex,QWORD damage,QWORD ShieldDamage);
