...
bool CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex, CItem* lpItem) // OK
{
	...
	if (lpItem->m_Index > GET_ITEM(12, 6) &&
		...
		&& lpItem->m_Index != GET_ITEM(13, 22)
		&& lpItem->m_Index != GET_ITEM(13, 23)
		&& lpItem->m_Index != GET_ITEM(13, 24)
		&& lpItem->m_Index != GET_ITEM(13, 25)
		&& lpItem->m_Index != GET_ITEM(13, 26)
		&& lpItem->m_Index != GET_ITEM(13, 27)
		&& lpItem->m_Index != GET_ITEM(13, 28)
		&& lpItem->m_Index != GET_ITEM(13, 202)
		&& lpItem->m_Index != GET_ITEM(13, 203)
		&& lpItem->m_Index != GET_ITEM(13, 204)
		&& lpItem->m_Index != GET_ITEM(13, 205)
		&& lpItem->m_Index != GET_ITEM(13, 206)
		&& lpItem->m_Index != GET_ITEM(13, 207)
		&& gCustomWing.CheckCustomWingByItem(lpItem->m_Index) == 0)
	{
		LogAdd(LOG_RED, "Check 11");
		return 0;
	}
	...
	{
		LogAdd(LOG_RED, "Check wing");
		return 0;
	}
	if (lpInfo->EnableSlotRing == 0 && (lpItem->m_Index == GET_ITEM(13, 8)
		|| lpItem->m_Index == GET_ITEM(13, 9)
		|| lpItem->m_Index == GET_ITEM(13, 12)
		|| lpItem->m_Index == GET_ITEM(13, 13)
		|| lpItem->m_Index == GET_ITEM(13, 21)
	...
	if (lpInfo->MaxItemOption1 != -1 && (lpItem->m_Option1 > lpInfo->MaxItemOption1 || ItemInfo.m_wSkillIndex == 0))
	{
		return 0;
	}
...
{
	if ((lpItem->m_Index >= GET_ITEM(12, 36) && lpItem->m_Index <= GET_ITEM(12, 240)) && GetSocketOptionCount(lpItem->m_SocketOption) < 5)
	{
		return 1;
	}
