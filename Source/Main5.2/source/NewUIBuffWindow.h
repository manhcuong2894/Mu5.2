...
namespace SEASON3B
{
	...
	public:
		void SetBuffPower(eBuffState bufftype, WORD power);
		WORD GetBuffPower(eBuffState bufftype);
		void ClearBuffPower(eBuffState bufftype);

	private:
		std::map<eBuffState, WORD> m_BuffPowerMap;
	};
