...
void SEASON3B::CNewUICharacterInfoWindow::RenderTableTexts()
{
	...
	unicode::_sprintf(strLevel, gTextClient.txtClient_ThongTin[33], CharacterAttribute->Level, GMResetManager->GetResetCount());
...
//#endif // test_main_dev
	...
	if (CharacterMachine->Lock)
		sprintf_s(strText, gTextClient.txtClient_ThongTin[0]); //Lock: Active z
	
	else
		sprintf_s(strText, gTextClient.txtClient_ThongTin[1]); //Lock: Disabled
	g_pRenderText->RenderFont(PosX + 20, PosY + 70, strText, 150, 0, RT3_SORT_LEFT);

	sprintf_s(strText, gTextClient.txtClient_ThongTin[2], CharacterMachine->AccountLevel); //AccountLevel: %d
	g_pRenderText->RenderFont(PosX + 20, PosY + 86, strText, 150, 0, RT3_SORT_LEFT);

	if (CharacterMachine->AccountExpireDate[0] != '\0')
		sprintf_s(strText, gTextClient.txtClient_ThongTin[3], CharacterMachine->AccountExpireDate); //Accoun Expire: %s
	else
		sprintf_s(strText, gTextClient.txtClient_ThongTin[4]); //Accoun Expire: --------
...
void SEASON3B::CNewUICharacterInfoWindow::RenderEquipementAttribute()
{
	...
	g_pRenderText->RenderFont(PosX + 25, PosY + 135, gTextClient.txtClient_ThongTin[5], 0, 0, RT3_SORT_LEFT); //"-Effects and Options"
...
void SEASON3B::CNewUICharacterInfoWindow::ReceiveAdvanceChar(BYTE* ReceiveBuffer)
{
	...
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[6], TRUE, TRUE, 0)); //"ATK Info"

	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[7], TRUE, Data->AttackSuccessRate));		   //"ATK Success Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[8], !TRUE, Data->m_ReflectDmg));			   //"Reflect Dmg Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[9], !TRUE, Data->m_ReflectDmgRate));		   //"Reflect Dmg FULL"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[10], !TRUE, Data->m_CriticalDmgRate));		   //"Critical Dmg Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[11], !TRUE, Data->m_ExcellentDmgRate));	   //"Excellent Dmg Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[12], !TRUE, Data->m_DoubleDmgRate));		   //"Double Dmg Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[13], !TRUE, Data->m_IncIgnoreShield));		   //"Ign DEF SD "
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[14], !TRUE, Data->m_IncIgnoreDefense));	   //"Ign Enemy's DEF"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[15], !TRUE, Data->m_ResIgnoreDefense));	   //"Ign Enemy's ATK"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[16], !TRUE, Data->m_TripleDmgRate));		   //"Triple Dmg Rate"

	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[17], TRUE, TRUE, 0));							//"- DEF Info"

	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[18], TRUE, Data->DefenseSuccessRate));			 //"DEF Success Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[19], !TRUE, Data->m_ResAttackStunRate));		 //"Resistance Stuck"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[20], !TRUE, Data->m_ResCriticalDmgRate));		 //"Critical Def Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[21], !TRUE, Data->m_ResExcellentDmgRate));		 //"Excellent Def Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[22], !TRUE, Data->m_ResDoubleDmgRate));		 //"Double Def Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[23], !TRUE, Data->m_DmgReductionRate));		 //"Reducction Dmg Rate"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[24], !TRUE, Data->m_ResIgnoreShield));			 //"Ign ATK SD"

	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[25], FALSE, Data->OffFullHPRestoreRate)); //"Recovery Offen HP"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[26], FALSE, Data->DefFullHPRestoreRate)); // "Recovery Defen HP"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[27], FALSE, Data->OffFullMPRestoreRate)); // "Recovery Offen MP"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[28], FALSE, Data->DefFullMPRestoreRate)); // "Recovery Defen MP"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[29], FALSE, Data->OffFullSDRestoreRate)); // "Recovery Offen SD"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[30], FALSE, Data->DefFullSDRestoreRate)); // "Recovery Defen SD"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[31], FALSE, Data->OffFullBPRestoreRate)); // "Recovery Offen BP"
	m_advanceChar.push_back(CHARACTER_ADVANCE_DESC(gTextClient.txtClient_ThongTin[32], FALSE, Data->DefFullBPRestoreRate)); // "Recovery Defen BP"
}
