...
public:
	...
	virtual void UpdateItemChar(int iEquipmentSlot, const ITEM* pItem);
	virtual void SetAngle(float fDegree);
	virtual void SetZoom(float fZoom);
	virtual void SetZoomLimit(float fMinZoom, float fMaxZoom);
