...
bool SEASON3B::CNewUIOptionWindow::UpdateMouseEvent()
{
	...
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 45.0, 15, 15))
	{
		m_bAutoAttack = !m_bAutoAttack;
	}
	/*if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 63.0, 15, 15))
	{
	...
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 81.0, 15, 15))
	{
		m_RenderEffect = !m_RenderEffect;
	}
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 99.0, 15, 15))
	{
		m_RenderEquipment = !m_RenderEquipment;
	}
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 117.0, 15, 15))
	{
		m_RenderTerrain = !m_RenderTerrain;
	}
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 210.0, RenderFrameY + 135.0, 15, 15))
	{
	...
	if (SEASON3B::IsPress(VK_LBUTTON) && CheckMouseIn(RenderFrameX + 310.0, RenderFrameY + 45.0, 15, 15)) { SetFpsIndex(0); return false; }
...
{
	window_backmsg(m_Pos.x, m_Pos.y, 340.f, 270.f);
	...
	RenderBitmap(Bitmap_point_draw, ((float)m_Pos.x + 238.f), (float)m_Pos.y + 32.f, 8.f, 8.f, 0.f, 0.f, 14.f / 16.f, 14.f / 16.f);
...
void SEASON3B::CNewUIOptionWindow::RenderContents()
{
	...
	g_pRenderText->RenderText(RenderFrameX + 170, RenderFrameY + 8, gTextClient.txtClient_Khac[11], 0, 0, 8);

	g_pRenderText->RenderText(RenderFrameX + 30, RenderFrameY + 32, gTextClient.txtClient_Khac[4]); //--

	g_pRenderText->RenderText(RenderFrameX + 30, RenderFrameY + 157, gTextClient.txtClient_Khac[5]); //--

	g_pRenderText->RenderText(RenderFrameX + 250, RenderFrameY + 32, gTextClient.txtClient_Khac[10]);
	...
	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 45, GlobalText[386], 0, 15); //-- Automatic Attack

	//g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 58, GlobalText[387], 0, 15); //-- Beep sound for whispering

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 63, GlobalText[919], 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 81, gTextClient.txtClient_Khac[6], 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 99, gTextClient.txtClient_Khac[7], 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 117, gTextClient.txtClient_Khac[8], 0, 15); //-- Slide Help

	g_pRenderText->RenderText(RenderFrameX + 100, RenderFrameY + 135, gTextClient.txtClient_Khac[9], 0, 15); //-- Slide Help
	...
	g_pRenderText->SetTextColor(CLRDW_GOLD);
	g_pRenderText->SetTextColor(255, 255, 255, 255);
	g_pRenderText->RenderText(RenderFrameX + 250, RenderFrameY + 45, "25 FPS");
...
void SEASON3B::CNewUIOptionWindow::RenderButtons()
{
	...
	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 45.0, m_bAutoAttack);

	//RenderChecked(RenderFrameX + 210.0, RenderFrameY + 58.0, m_bWhisperSound);

	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 63.0, m_bSlideHelp);

	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 81.0, m_RenderEffect);

	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 99.0, m_RenderEquipment);

	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 117.0, m_RenderTerrain);

	RenderChecked(RenderFrameX + 210.0, RenderFrameY + 135.0, m_RenderObjects);

	RenderChecked(RenderFrameX + 310.0, RenderFrameY + 45, m_iFpsIndex == 0);
...
void SEASON3B::CNewUIOptionWindow::SetFpsIndex(int index)
{
	m_iFpsIndex = index;
	targetIndexFPS = index;
	leaf::CRegKey regkey;
	regkey.SetKey(leaf::CRegKey::_HKEY_CURRENT_USER, "SOFTWARE\\Webzen\\Mu2\\Config");
...
int SEASON3B::CNewUIOptionWindow::GetFpsIndex()
{
	return m_iFpsIndex;
}