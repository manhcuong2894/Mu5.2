...
static bool IsPriorityWingParticle(int Type, int SubType, const vec3_t Position, OBJECT* Owner)
{
	return IsHeroOrWingParticleOwner(Owner)
		|| (IsWingGlowParticleType(Type, SubType) && IsNearHeroParticlePosition(Position));
}
