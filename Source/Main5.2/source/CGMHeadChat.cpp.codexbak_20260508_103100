...
void CGMHeadChat::SetBooleanPosition(CHAT *c) {
  ...
  if (gmProtect->m_RenderCharacterName &&
    ...
    if (g_isCharacterBuff((&pCharacter->Object), eBuff_GMEffect) ||
      ...
      bResult[0] = g_pMultiLanguage->_GetTextExtentPoint32(
          g_pRenderText->GetFontDC(), c->ID, lstrlen(c->ID), &Size[0]);
    ...
    bResult[1] = g_pMultiLanguage->_GetTextExtentPoint32(
        g_pRenderText->GetFontDC(), c->Text[0], lstrlen(c->Text[0]), &Size[1]);
    bResult[2] = g_pMultiLanguage->_GetTextExtentPoint32(
        g_pRenderText->GetFontDC(), c->Text[1], lstrlen(c->Text[1]), &Size[2]);
    bResult[3] = g_pMultiLanguage->_GetTextExtentPoint32(
        g_pRenderText->GetFontDC(), c->Union, lstrlen(c->Union), &Size[3]);
    bResult[4] = g_pMultiLanguage->_GetTextExtentPoint32(
        g_pRenderText->GetFontDC(), c->Guild, lstrlen(c->Guild), &Size[4]);
    ...
    if (lstrlen(c->szShopTitle) > 0) {
      ...
      if (g_pMultiLanguage->_GetTextExtentPoint32(
              g_pRenderText->GetFontDC(), c->szShopTitle,
              lstrlen(c->szShopTitle), &sizeT[0]) &&
          g_pMultiLanguage->_GetTextExtentPoint32(
              g_pRenderText->GetFontDC(), GlobalText[1104],
              lstrlen(GlobalText[1104]), &sizeT[1])) {
  ...
  if (gmProtect->m_RenderCharacterName &&
      (pCharacter->GetKind() == KIND_PLAYER ||
       pCharacter->GetKind() == KIND_MONSTER)) {
    bResult[1] = GMFontLayer->_GetTextExtentPoint32(
        c->Text[0], lstrlen(c->Text[0]), &Size[1]);
    bResult[2] = GMFontLayer->_GetTextExtentPoint32(
        c->Text[1], lstrlen(c->Text[1]), &Size[2]);
    bResult[3] = GMFontLayer->_GetTextExtentPoint32(c->Union, lstrlen(c->Union),
                                                    &Size[3]);
    bResult[4] = GMFontLayer->_GetTextExtentPoint32(c->Guild, lstrlen(c->Guild),
                                                    &Size[4]);
  } else {
    bResult[1] = g_pMultiLanguage->_GetTextExtentPoint32(
        g_pRenderText->GetFontDC(), c->Text[0], lstrlen(c->Text[0]), &Size[1]);
  ...
  if (lstrlen(c->szShopTitle) > 0) {
    ...
    if (g_pMultiLanguage->_GetTextExtentPoint32(
            g_pRenderText->GetFontDC(), c->szShopTitle, lstrlen(c->szShopTitle),
            &sizeT[0]) &&
        g_pMultiLanguage->_GetTextExtentPoint32(
            g_pRenderText->GetFontDC(), GlobalText[1104],
            lstrlen(GlobalText[1104]), &sizeT[1])) {
...
void CGMHeadChat::RenderBoolean(int x, int y, CHAT *c) {
  ...
  if (gmProtect->m_RenderCharacterName &&
    ...
    if (pCharacter->GetKind() == KIND_PLAYER &&
      ...
      GMFontLayer->_GetTextExtentPoint32(c->ID, lstrlen(c->ID), &nameSize);
    }
