...
namespace SEASON3B
{
	...
	void begin3D();
	void endrender3D();
	void RenderLocalItem3D(float sx, float sy, float Width, float Height, int Type, int Level = 0, int Option1 = 0, int ExtOption = 0, bool PickUp = false, float Scale = 0.0f);
	void Render2Item3D(float sx, float sy, float Width, float Height, int Type, int Level = 0, int Option1 = 0, int ExtOption = 0, bool PickUp = false, float Scale = 0.0f);
