...
void FriendMemoSend(FHP_FRIEND_MEMO_SEND* lpMsg, int index)
{
	...
	// T_FriendMail.Photo is binary(48). Binding all 13 DWORD equipment bytes
	// (52 bytes) makes the whole UPDATE fail, leaving Memo empty.
	gQueryManager.BindParameterAsBinary(2, lpMsg->Equipment, 48);
